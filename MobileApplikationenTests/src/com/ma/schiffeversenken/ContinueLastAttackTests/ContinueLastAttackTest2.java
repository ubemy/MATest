...
public class ContinueLastAttackTest2 extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		fieldUnits[0] = firstField.getElementByID(31);
		fieldUnits[1] = firstField.getElementByID(41);
		fieldUnits[2] = firstField.getElementByID(51);
		
		ki.updateHistory(31, true, false, fieldUnits);
		ki.updateHistory(41, true, false, fieldUnits);
		ki.updateHistory(51, true, false, fieldUnits);
	}
